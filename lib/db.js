...
export async function saveTrip(trip) {
  const db = sql();
  await db`
    INSERT INTO trips (trip_key, vehicle_key, vehicle_nickname, started_at, ended_at, gps_distance, received_at)
    VALUES (${trip.trip_key}, ${trip.vehicle_key}, ${trip.vehicle_nickname}, ${trip.started_at}, ${trip.ended_at}, ${trip.gps_distance}, NOW())
